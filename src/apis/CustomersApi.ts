...
export class CustomersApi extends runtime.BaseAPI {
     ...
     */
    async getCustomerBalanceRaw(requestParameters: GetCustomerBalanceRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<any>> {
     ...
     * Get Customer\'s Cash Balance
     */
    async getCustomerBalance(id: string, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<any> {
     ...
     */
    async listCustomerPaymentMethodsRaw(requestParameters: ListCustomerPaymentMethodsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<any>> {
        if (requestParameters['id'] == null) {
            throw new runtime.RequiredError(
                'id',
    ...
    async listCustomersRaw(requestParameters: ListCustomersRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ListCustomersResponseDto>> {
        if (requestParameters['merchantId'] == null) {
            throw new runtime.RequiredError(
                'merchantId',
                'Required parameter "merchantId" was null or undefined when calling listCustomers().'
            );
        }
     ...
     * Retrieve Customer
     */
    async retrieveCustomerRaw(requestParameters: RetrieveCustomerRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<any>> {
        if (requestParameters['id'] == null) {
            throw new runtime.RequiredError(
                'id',
     ...
     * Retrieve Customer
     */
    async retrieveCustomer(id: string, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<any> {
     ...
     * Update Customer
     */
    async updateCustomerRaw(requestParameters: UpdateCustomerRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<any>> {
        if (requestParameters['id'] == null) {
            throw new runtime.RequiredError(
                'id',
     ...
     * Update Customer
     */
    async updateCustomer(id: string, updateCustomerDto: UpdateCustomerDto, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<any> {
