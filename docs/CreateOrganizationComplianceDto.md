...
```typescript
import type { CreateOrganizationComplianceDto } from '@cashful-co/typescript'
...
const example = {
  ...
  "companyMobileMoneySettlementNumber": null,
  "companyEmail": null,
...
const exampleParsed = JSON.parse(exampleJSON) as CreateOrganizationComplianceDto
