...
```typescript
import type { UpdateOrganizationKycDto } from '@cashful-co/typescript'
...
} satisfies UpdateOrganizationKycDto
...
const exampleParsed = JSON.parse(exampleJSON) as UpdateOrganizationKycDto
