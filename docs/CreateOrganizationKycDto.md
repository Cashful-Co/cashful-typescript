...
```typescript
import type { CreateOrganizationKycDto } from '@cashful-co/typescript'
...
} satisfies CreateOrganizationKycDto
...
const exampleParsed = JSON.parse(exampleJSON) as CreateOrganizationKycDto
